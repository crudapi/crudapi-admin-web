...
if(!moor._hasResource["moor._firebug.firebug"]){
moor._hasResource["moor._firebug.firebug"]=true;
moor.provide("moor._firebug.firebug");
moor.deprecated=function(_1,_2,_3){
...
moor.experimental=function(_5,_6){
...
if(!moor.isFF&&!moor.isChrome&&!moor.isSafari&&!_8&&!window.firebug&&(typeof console!="undefined"&&!console.firebug)&&!moor.config.useCustomLogger&&!moor.isAIR){
try{
...
moor.destroy(_f.firstChild);
}
}
moor.forEach(this._connects,moor.disconnect);
},open:function(){
_34(true);
},close:function(){
if(_14){
...
_1a=moor.connect(document,"mousemove",function(evt){
if(!_1c){
return;
}
if(!_1d){
...
setTimeout(function(){
_1b=moor.connect(document,"click",function(evt){
...
if(moor.config.debugContainerId){
_e=_b.getElementById(moor.config.debugContainerId);
}
if(!_e){
...
_49(_12,"keydown",_4a);
_49(_b,moor.isIE||moor.isSafari?"keydown":"keypress",_4b);
...
btn.obj=obs[i];
_c.console._connects.push(moor.connect(btn,"onclick",function(){
...
_b6=(_b6)?moor.fromJson(_b6):[];
var pos=moor.indexOf(_b6,_b5);
if(pos!=-1){
_b6.splice(pos,1);
}
_b6.push(_b5);
_b7("firebug_history",moor.toJson(_b6),30);
...
_49(document,moor.isIE||moor.isSafari?"keydown":"keypress",_4b);
if((document.documentElement.getAttribute("debug")=="true")||(moor.config.isDebug)){
_34(true);
}
moor.addOnWindowUnload(function(){
_a1(document,moor.isIE||moor.isSafari?"keydown":"keypress",_4b);
